...
import { TrendingUp, Target, Zap, Activity, BarChart3, Brain, ChevronDown } from "lucide-react"
...
# RMSE penalizes larger errors more than MAE`,
  ...
  return (
    <section id="concepts" className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">Concept Learning</h2>
