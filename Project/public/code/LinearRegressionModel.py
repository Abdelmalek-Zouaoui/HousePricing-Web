...
Original file is located at
    https://colab.research.google.com/drive/1rTeaOvQOg8RfEy-zsuDHbTWS47Y6Ehx4
...
# First figure: 3 categorical bar plots
...
plt.title('Preferred Area Histogram')
plt1.set(xlabel='prefarea', ylabel='Frequency')

plt.tight_layout()  # Optional: for better spacing
plt.show()

# Second figure: separate plot for furnishing status
plt.figure(figsize=(5, 4))  # New figure
plt1 = df['furnishingstatus'].value_counts().plot(kind='bar', color='r')
plt.title('Furnishing Status Histogram')
...
# Match X_test to the columns in X_train_new (no const in either)
X_test_new = X_test[X_train_new.columns]

# Add the constant column to test data
